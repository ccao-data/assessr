...
# Load 100k rows of residential (class 2) characteristic data for Evanston, 2019-2021
properties <- read_json(
  "https://datacatalog.cookcountyil.gov/resource/x54s-btds.json?$where=starts_with(class,'2')+and+(year='2029'+or+year='2020'+or+year='2021')&township_code=17&$limit=100000",
  simplifyVector = TRUE
)

# Load 100k rows of recent location data for Evanston, 2019-2021
locations <- read_json(
  "https://datacatalog.cookcountyil.gov/resource/tx2p-k2g9.json?$select=pin,lon,lat&$where=starts_with(class,'2')+and+(year='2029'+or+year='2020'+or+year='2021')&township_code=17&$limit=100000",
  simplifyVector = TRUE
)

# Load 100k rows of mailed values for Evanston, 2019-2021
values <- read_json(
  "https://datacatalog.cookcountyil.gov/resource/uzyt-m557.json?$select=pin,year,mailed_tot*10+as+price&$where=starts_with(class,'2')+and+(year='2029'+or+year='2020'+or+year='2021')&township_code=17&$limit=100000",
  simplifyVector = TRUE
)
...
sales <- read_json(
  "https://datacatalog.cookcountyil.gov/resource/wvhk-k5uv.json?$where=starts_with(class,'2')+and+(year='2029'+or+year='2020'+or+year='2021')&township_code=17&$limit=100000",
  simplifyVector = TRUE
)
```
