...
```{r find_comps2, include=FALSE, ref.label="find_comps", cache=FALSE}
```
...
<button class=toggle_button onclick="plot_switch('table1', 'table2')">Switch Distance Trade-Off Parameter Value</button>
...
```{r find_comps3, include=FALSE, ref.label="find_comps", cache=FALSE}
```
...
```{r find_comps4, include=FALSE, ref.label="find_comps", cache=FALSE}
```
...
<button class=toggle_button onclick="plot_switch('map1', 'map2')">Switch Distance Trade-Off Parameter Value</button>
...
```{r find_comps5, include=FALSE, ref.label="find_comps", cache=FALSE}
```
...
```{r find_comps6, include=FALSE, ref.label="find_comps", cache=FALSE}
```
...
<button class=toggle_button onclick="plot_switch('dist1', 'dist2')">Switch Distance Trade-Off Parameter Value</button>
